function [Y,W,SetupStruc] = Process_ILRMA(s,Transfer,SetupStruc)
K = SetupStruc.ILRMA.K;
hop = SetupStruc.ILRMA.hop;
win = hanning(K,'periodic');
win = win/sqrt(sum(win(1:hop:K).^2));
SetupStruc.ILRMA.win = win;  % Preserve 'win' in 'SetupStruc'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N = size(s,2);
for i = 1:N
