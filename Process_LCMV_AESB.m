function [Y,W,SetupStruc] = Process_LCMV_AESB(s,Transfer,SetupStruc)
K = SetupStruc.LCMV_AESB.K;
hop = SetupStruc.LCMV_AESB.hop;
win = hanning(K,'periodic');
win = win/sqrt(sum(win(1:hop:K).^2));
SetupStruc.LCMV_AESB.win = win;  % Preserve 'win' in 'SetupStruc'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N = size(s,2);
for i = 1:N
